...
# Authentication 
s.login("transactorlando@gmail.com", "bonus4us") 
...
data = {
  'RecordingDateIDStart': f"{month}/{day}/{year}r",
  'RecordingDateIDEnd': '',
...
print(message)
if len(needed) >0:
  s.sendmail(from_addr="transactorlando@gmail.com", to_addrs="bilbobaggins20711@gmail.com", msg=message )
  print("Email Sent")
