...
$(document).ready(function () {
    ...
    var IS_GBAT = {% if is_defined('view.group_by_arrival_time') and view.group_by_arrival_time %}true{% else %}false{% endif %};
    ...
    function setTabHiddenStatus(isHidden) {
      ...
      // if it's not GBAT, there is no need to keep the user active on the wait page.
      if (IS_GBAT) {
